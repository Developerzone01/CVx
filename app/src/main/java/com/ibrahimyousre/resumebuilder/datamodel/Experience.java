...
public class Experience extends ResumeEvent {
    ...
    public String getStartDate() { return getShortDescription(); }

    public void setStartDate(String startDate) {
        setShortDescription(startDate);
    }

    public String getEndDate() { return getLongDescription(); }

    public void setEndDate(String endDate) {
        setLongDescription(endDate);
    }
}
