...
public class ResumeEvent implements Parcelable {
    ...
    public ResumeEvent(String title, String detail, String subtitle, String description, Date fromDate, Date toDate,String shortdescription,String longdescription) {
        this.title = title;
        this.detail = detail;
    ...
    public void cloneThis(ResumeEvent resumeEvent) {
        ...
        this.shortdescription= resumeEvent.shortdescription;
        this.longdescription= resumeEvent.longdescription;
    }
