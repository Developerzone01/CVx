...
import com.ibrahimyousre.resumebuilder.fragments.HobbiesFragment;
...
import com.ibrahimyousre.resumebuilder.fragments.ReferencesFragment;
import com.ibrahimyousre.resumebuilder.fragments.TemplateFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean handleMenuItem(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_experience:
                ...
                break;
            case R.id.action_Preview_Template:
                openFragment(TemplateFragment.newInstance(resume));
                break;
            case R.id.action_hobbies:
                openFragment(HobbiesFragment.newInstance(resume));
                break;
            case R.id.action_references:
                openFragment(ReferencesFragment.newInstance(resume));
                break;
            default:
                return false;
        }
    ...
    public void openFragment(ResumeFragment fragment) {
